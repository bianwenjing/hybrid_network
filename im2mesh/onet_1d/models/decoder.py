...
class DecoderCBatchNorm(nn.Module):
    ...
    def __init__(self, yz_resolution, dim=2, z_dim=128, c_dim=128,
        ...
        self.fc_out = nn.Conv1d(hidden_size, yz_resolution*yz_resolution, 1)
        # self.fc_out = nn.Linear(hidden_size, z_resolution)
    ...
    def forward(self, p, z, c, **kwargs):
        ...
        out = out.view(batch_size, T, self.yz_resolution, self.yz_resolution)
